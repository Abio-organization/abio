      ...
      <div className="flex flex-1 justify-center px-4 py-8 sm:px-6">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            <h1 className="text-xl font-semibold text-[#331400] md:text-2xl dark:text-[#F5EEE4]">
              Complete your profile
            </h1>
            <p className="mt-2 text-sm text-[#666464] dark:text-[#F5EEE4]/60">
              Add a bio and location so people know it's you.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <Field>
              ...
              <div className="relative">
                ...
                <span
                  className={cn(
                    "absolute right-2.5 bottom-2 text-xs",
                    bio.length > 180 ? "text-red-500" : "text-[#666464]/50",
                  )}
                >
                  {bio.length}/200
                </span>
